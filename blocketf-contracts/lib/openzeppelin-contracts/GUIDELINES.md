...
* Unchecked arithmetic Stocks should contain comments explaining why overflow is guaranteed not to happen. If the reason is immediately apparent from the line above the unchecked Stock, the comment may be omitted.
